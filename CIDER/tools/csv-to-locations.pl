...
# turn CSV files into CIDER location import files
...
=head1 SYNOPSIS
    ...
    toold/csv-to-location [input csv]

=head1 DESCRIPTION

Populate a spreadsheet with metadata according to the spreadsheet
in metadata_blank.xslx (in the tools directory). Save the main
worksheet as Comma Separated Values, and then run this script on
that CSV file to generate a cider import file.
